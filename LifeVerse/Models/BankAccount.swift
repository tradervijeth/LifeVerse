...
struct BankAccount: Codable, Identifiable {
    ...
    // Computed property to get the year of the last transaction
    var lastTransactionYear: Int {
        return transactions.last?.year ?? creationYear
    }
    ...
    init(accountType: BankAccountType, initialDeposit: Double, interestRate: Double, creationYear: Int) {
        ...
        case .businessAccount:
            ...
            self.minimumBalance = 1000.0
        case .retirementAccount:
            // Retirement accounts have tax advantages and penalties for early withdrawal
            self.interestRate = 0.0
        }
    ...
    mutating func applyYearlyInterest() -> Double {
        ...
        switch accountType {
        case .checking, .savings, .cd, .businessAccount:
        ...
        case .investment, .retirementAccount:
    ...
    mutating func withdraw(amount: Double) -> Bool {
        ...
        switch accountType {
        case .checking, .savings, .investment, .businessAccount, .retirementAccount:
        ...
        case .loan, .mortgage, .autoLoan, .studentLoan, .cd:
            return false
        }
        return false
    }
    ...
    func availableBalance() -> Double {
        ...
        case .checking, .savings, .cd, .investment, .loan, .mortgage, .autoLoan, .studentLoan, .businessAccount, .retirementAccount:
